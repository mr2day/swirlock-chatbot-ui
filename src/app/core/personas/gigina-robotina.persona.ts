 ...
 * different palette: the dark background carries a warm pink-purple
 * tint to harmonize with the character's body color, and the accent
 * is a saturated pink instead of Gigi's yellow.
 */
